...
class CGameContext : public IGameServer
{
	...
	static void ConAiStart(IConsole::IResult *pResult, void *pUserData);
	static void ConAiStop(IConsole::IResult *pResult, void *pUserData);
	static void ConAiReset(IConsole::IResult *pResult, void *pUserData);
	static void ConAiSave(IConsole::IResult *pResult, void *pUserData);
	static void ConAiLoad(IConsole::IResult *pResult, void *pUserData);
	static void ConAiTimescale(IConsole::IResult *pResult, void *pUserData);
	static void ConAiTurbo(IConsole::IResult *pResult, void *pUserData);
...
public:
	...
	CEvolutionManager *EvolutionManager() { return m_pEvolutionManager; }
	...
	CEvolutionManager *m_pEvolutionManager;
	CGameWorld m_World;

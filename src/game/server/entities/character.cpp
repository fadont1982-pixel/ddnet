...
void CCharacter::PreTick()
{
	...
	if(GameServer()->EvolutionManager() && GameServer()->EvolutionManager()->IsActive())
	{
		GameServer()->EvolutionManager()->OnCharacterPreTick(this);
	}
...
void CCharacter::Die(int Killer, int Weapon, bool SendKillMsg)
{
	...
	if(GameServer()->EvolutionManager())
		GameServer()->EvolutionManager()->OnBotDeath(m_pPlayer->GetCid());
...
bool CCharacter::CanSnapCharacter(int SnappingClient)
{
	...
	if(GameServer()->EvolutionManager() && GameServer()->EvolutionManager()->IsActive() && GameServer()->EvolutionManager()->IsBot(m_pPlayer->GetCid()))
		return true;
...
void CCharacter::HandleTiles(int Index)
{
	...
	if(TeleCheckpoint)
	{
		...
		if(GameServer()->EvolutionManager())
			GameServer()->EvolutionManager()->OnBotReachCheckpoint(m_pPlayer->GetCid(), TeleCheckpoint);
	}

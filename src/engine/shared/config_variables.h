 ...
 */
MACRO_CONFIG_INT(SvAiTimescale, sv_ai_timescale, 1, 1, 100, CFGFLAG_SERVER, "Timescale simulation speed multiplier for AI")
MACRO_CONFIG_INT(SvAiTurbo, sv_ai_turbo, 0, 0, 1, CFGFLAG_SERVER, "AI Turbo mode: run simulation ticks as fast as possible without wait")
MACRO_CONFIG_INT(ClAiHud, cl_ai_hud, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show AI evolution HUD overlay")
MACRO_CONFIG_INT(ClAiCamFollow, cl_ai_cam_follow, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Follow leading AI bot with camera")
MACRO_CONFIG_INT(ClAiTurbo, cl_ai_turbo, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "AI Turbo mode display: disable heavy world rendering and show dashboard")
